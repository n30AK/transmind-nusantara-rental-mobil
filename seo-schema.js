...
(function(){
  ...
  function boot(){
    ...
    var data={
      ...
      '@graph':[
        {'@type':'LocalBusiness','@id':'https://transmindnusantararentalmobil.co.id/#business','name':'Transmind Nusantara Rental Mobil','url':'https://transmindnusantararentalmobil.co.id/','telephone':'+6281292677888','areaServed':['Bekasi','Jakarta','Bogor','Depok','Tangerang','Jabodetabek'] ,'sameAs':['https://www.instagram.com/transmind.nusantara/','https://www.tiktok.com/@transmindrentalmobil','https://x.com/transmindnusant'],'priceRange':'$','description':'Rental mobil Jabodetabek untuk lepas kunci, dengan driver, corporate, wedding dan pariwisata.'},
