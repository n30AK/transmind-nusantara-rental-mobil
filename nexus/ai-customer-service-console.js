...
function shell(el){
 ...
 <div class="acs-grid" style="margin-top:12px">
  ...
  <div class="acs-card"><div class="acs-note">Tracking health</div><div class="acs-value acs-ok" id="acs-health">CHECK</div><div class="acs-note">CTA → AI → booking</div></div>
 </div>
...
async function renderData(){
 ...
 const [ev,tasks,sigs,comms]=await Promise.all([
